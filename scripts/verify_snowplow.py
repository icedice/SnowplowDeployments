...
def extract():
	...
	contexts_to_extract = [
		...
		Context("dk.jyllands-posten/user/", [("anon_id", str), ("user_id", str), ("user_authenticated", str), ("user_authorized", str), ("ab_group", int)]),
		Context("dk.jyllands-posten/page_view/", [("section_id", int), ("section_name", str), ("content_id", int), ("content_type", str), ("page_name", str), ("page_type", str), ("page_restricted", str), ("site", str), ("sub_site", str), ("editorial_category", str)])
	]
	...
	# TODO Embarrassingly parallel over the dir_base values.
